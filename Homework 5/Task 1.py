...
def letter_stat(our_str):
    """
    Функция letter_stat на вход принимает строку our_str и возвращает словарь letters_dict,
    где в качестве ключей буквы строки, а значениями являются числа,
    соответствующие количеству вхождений данной буквы в строку.
    :param our_str: Строка на входе
    :return: (letters_dict) Полученный словарь по типу "символ:кол-во вхождений"
    """
    letters_dict = {}
