...
def repeats(our_str):
    """
    Функция repeats принимает на вход строку our_str и смотрит, сколько раз каждый символ уже встречался
    и добавляет количество к символам с помощью постфикса формата _n
    :param our_str: Входные данные
    :return: (new_str) Новая строка с нумерацией формата _n
    """
    letter_dict = {}
    new_str = str()
