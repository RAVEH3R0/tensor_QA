...
def segment(point_1: tuple, point_2: tuple):
    """
    Вычисляет сумму координат двух точек
    :param point_1: первая точка с координатами x1, y1
    :param point_2: вторая точка с координатами x2, y2
    :return: Возвращает сумму всех координат, в случае исключения возвращает текст исключения задом наперед
    """
    try:
