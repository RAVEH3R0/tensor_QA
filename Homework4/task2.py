...
def flatten_and_sort(array):
    """
    Функция flatten_and_sort принимает двумерый массив (список списков) array, и возвращает "плоский" список со всеми числами в порядке возрастания result_list
    :param array: Вложенные списки
    :return: (result_list) Плоские списки с числами в порядке возрастания
    """
    result_list = []
