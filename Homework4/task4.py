...
def multiplication_chain(num):
    """
    Функция multiplication_chain принимает положительное число num и возвращает количество раз count_multy,
    которое вы должны перемножить цифры числа num и полученных произведений, пока не получится одна цифра
    :param num: Число
    :return: (count_multy) Количество перемножений цифр числа num и полученных произведений пока не получится одна цифра
    """
    count_multy = 0
    while num > 9:
        multipl = 1
